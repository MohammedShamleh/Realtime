...
public class AddNewStudentActivity extends AppCompatActivity {
    ...
    private void addStudentToDatabase() {
        ...
        String transmission = etNo.getText().toString();
        ...
        if (name.isEmpty()) {
            ...
            if (selectedImage != null) {
                            ...
                            ref.getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                                ...
                                public void onComplete(@NonNull Task<Uri> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        addToDatabase(name, transmission, imageUrl);
                                    }
                                }
                            });
                        } else {
                ...
                addToDatabase(name, transmission, "");
            }
        }
    }

    public void addToDatabase(String name, String transmission, String imageUrl) {
        // Open database connection and add values to database
        FirebaseDatabase db = FirebaseDatabase.getInstance();
        DatabaseReference ref = db.getReference("cars");

        String id = ref.push().getKey();
        car s = new car(id, name, transmission, imageUrl);
